...
MIN_REPLAY_SIZE = 1000  # from youtube tut
...
class Trainer():
    def __init__(self, device, memory, n_actions, policy_net, target_net):
    ...
    def optimize_model(self):
        ...
        # I think that is what this statement does... (kind of...) maybe rather have a "MIN_REPLAY_SIZE"
...
# print(f"max score: {max(episode_durations)}")
# # env.render()
# # env.close()
# plt.ioff()
# plt.show()
